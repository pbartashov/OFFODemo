...
public final class CoreDataRepository<T: NSManagedObject> {
    ...
    public var fetchedResultsPublisher: AnyPublisher<[T], Never> {
    ...
    public func get(predicate: NSPredicate?, sortDescriptors: [NSSortDescriptor]?) async throws -> [Entity] {
    ...
    public func delete(entity: Entity) async {
